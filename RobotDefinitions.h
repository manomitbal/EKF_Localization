 ...
 * RobotDefinitions.h
 *
 * Defines all pertitent structures and constants related to
 * robot state/model, landmark observations, and field characteristics.
 */
#ifndef _ROBOT_DEFINITIONS_H_
#define _ROBOT_DEFINITIONS_H_
